...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>Nueva reclamaci&oacute;n</h2>
        <ol class="breadcrumb">
            <li>
                <a>Inicio</a>
            </li>
                            ...
                            <div class="form-group">
                                <div class="col-sm-10 col-sm-offset-2" align="right">
                                    <div class="btn-group">
                                        ...
                                        <button class="btn btn-info" type="button" id="claim_save"><i class="fa fa-save"></i>&nbsp;Guardar</button>
                                        <button class="btn btn-success" type="button" id="claim_submit"><i class="fa fa-check"></i>&nbsp;Registrar</button>
                                    </div>
                                </div>
                            </div>
                        </form>
