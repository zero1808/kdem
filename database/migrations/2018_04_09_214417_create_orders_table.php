...
class CreateOrdersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('orders', function (Blueprint $table) {
            ...
            $table->time('arrive_date_time')->nullable();
            ...
            $table->string('responable_name',55)->nullable()->default(null);
            $table->string('responsable_phone',10)->nullable()->default(null);
            $table->string('responsable_email',30)->nullable()->default(null);
            $table->string('smx_gmx')->nullable()->default(null);
            $table->double('total_amount')->nullable()->default(null);
            $table->longText('src_carry_letter')->nullable()->default(null);	
            $table->longText('src_checklist')->nullable()->default(null);	
